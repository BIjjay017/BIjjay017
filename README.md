...
<div align="center">
  <img src="https://readme-typing-svg.demolab.com/?lines=Software+Developer+%40+NTCS;Full-Stack+%26+Backend+Engineer;AI%2FML+%26+RAG+Application+Developer;Technology+Explorer+%26+Avid+Traveler;Building+Practical%2C+Impactful+Solutions&center=true&width=550&height=50&color=38BDF8&size=20&vCenter=true" alt="Typing Animation" />
</div>
...
Software Developer at NTCS and CSIT candidate at Tribhuvan University (2021–2026). Focused on full-stack backend development, machine learning integrations, and asynchronous data processing systems.

* **Current Position:** Software Developer at NTCS
* **Location:** Kathmandu, Nepal
* **Education:** BSc. CSIT, Tribhuvan University
* **Core Disciplines:** Full-Stack Architecture, RAG & LLM Applications, Webhook Systems, Database Design
* **Certifications:** MERN Stack Development, NVIDIA Deep Learning Fundamentals, Kaggle ML Certificates
...
| Project | Technical Overview | Primary Stack | Links |
| :--- | :--- | :--- | :--- |
| **Customer Segmentation & Ad Distribution** | Automated machine learning clustering pipeline for targeting advertising campaigns based on customer behavioral data. | Python, Machine Learning, Data Analytics | [Repository](https://github.com/BIjjay017/Customer-Segmentation-and-Ad-Distribution) \| [Live Demo](https://customer-segmentation-and-ad-distribution.onrender.com) |
| **Data Visualization Application** | Web-based analytical data processing tool converting raw datasets into readable charts and statistical summaries. | Python, Data Analytics, Web | [Repository](https://github.com/BIjjay017/Data-Visualization-Application) \| [Live Demo](https://visualization-tool-omega.vercel.app/) |
| **WhatsApp Automated Chatbot** | Message processing service managing webhook integrations, automated routing, and response logic. | Node.js, Express, Webhooks | [Repository](https://github.com/BIjjay017/WhatsApp-Chatbot) |
| **Airline Booking System Backend** | Backend booking workflow handling flight schedules, seat inventory management, and route logic. | Python, SQL, Backend | [Repository](https://github.com/BIjjay017/Airline-Booking-System) |
